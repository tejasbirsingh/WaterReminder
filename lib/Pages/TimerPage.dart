...
class selectTheTimer extends StatefulWidget {
  @override
  _selectTheTimerState createState() => _selectTheTimerState();
}

class _selectTheTimerState extends State<selectTheTimer> {
  int timer = 0;
  int min = 0;
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text('Select Notification Reminder',
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: MediaQuery.of(context).orientation == Orientation.portrait ?    25.0: 20.0
                  ),),
               MediaQuery.of(context).orientation == Orientation.portrait ? SizedBox(height: 100.0,) :  SizedBox(height: 30.0,),
                Text(
                  '$timer Hr', style: TextStyle(
                    fontSize: MediaQuery.of(context).orientation == Orientation.portrait ?    30.0: 25.0,
                  color: Theme
                      .of(context)
                      .brightness == Brightness.dark
                      ? Colors.white
...
SizedBox(height: 10.0,),
               ...
               Row(
                   children: <Widget>[
                     ...
                     min == 0 && timer == 0 ? Container(height: 60) : _doneButton()
...
class FloatingNegative extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    // TODO: implement paint
    ...
    canvas.drawLine(Offset(size.width * 0.27, size.height * 0.5),
        Offset(size.width * 0.5, size.height * 0.5), redPaint);


    canvas.drawLine(Offset(size.width * 0.5, size.height * 0.5),
        Offset(size.width - (size.width * 0.27), size.height * 0.5), redPaint);
